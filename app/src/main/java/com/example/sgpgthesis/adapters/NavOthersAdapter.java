...
import com.example.sgpgthesis.activities.OthersDetailsActivity;
import com.example.sgpgthesis.models.NavOthersModel;

import java.util.List;

public class NavOthersAdapter extends RecyclerView.Adapter<NavOthersAdapter.ViewHolder>{

    Context context;
    List<NavOthersModel> list;

    public NavOthersAdapter(Context context, List<NavOthersModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, OthersDetailsActivity.class);
