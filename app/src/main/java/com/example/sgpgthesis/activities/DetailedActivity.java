...
public class DetailedActivity extends AppCompatActivity {
    ...
    ImageView increaseQuantity, decreaseQuantity,image;
...
//                startActivityForResult(intent, 100);
        ...
        increaseQuantity = findViewById(R.id.add_item);
        decreaseQuantity = findViewById(R.id.remove_item);
        ...
        .whereEqualTo("id", viewAllModel.getId()).get()
    ...
    void updateActualPriceWithDiscount(){
        ...
        totalPrice = viewAllModel.getPrice() * qty;
